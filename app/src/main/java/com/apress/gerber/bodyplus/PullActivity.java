...
public class PullActivity extends AppCompatActivity {
    ...
    TextView exerciseA, exerciseB, exerciseC, exerciseD, exerciseE, exerciseF, exerciseG, exerciseH;
    Button finish1, finish2, finish3, finish4, finish5, finish6, finish7, finish8;
    ...
    private void checkCompletion() {
        ...
        if (finish1.getText().equals("FINISHED") && finish2.getText().equals("FINISHED")
                ...
                getText().equals("FINISHED")){

            startActivity(new Intent(PullActivity.this, Dashboard.class));
            Toast.makeText(PullActivity.this, "SESSION COMPLETED", Toast.LENGTH_LONG).show();
        ...
        reference.child(userID).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userProfile != null){
                    ...
                    String fBi = userProfile.fBi;
                    String sBi = userProfile.sBi;
                    String fBack = userProfile.fBack;
                    String sBack = userProfile.sBack;
                    String fAbs = userProfile.fAbs;
                    String sAbs = userProfile.sAbs;
                    String tAbs = userProfile.tAbs;
                    String fSh = userProfile.fSh;

                    exerciseA.setText(fBack);
                    exerciseB.setText(sBack);
                    exerciseC.setText(fSh);
                    exerciseD.setText(fBi);
                    exerciseE.setText(sBi);
                    exerciseF.setText(fAbs);
                    exerciseG.setText(sAbs);
                    exerciseH.setText(tAbs);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(PullActivity.this, "something went wrong", Toast.LENGTH_LONG).show();
            }
        });
